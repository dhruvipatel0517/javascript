...
function CreateToaster(config) {
  ...
  return function (noti) {
    ...
    div.className = `toaster ${config.theme === "dark" ? "bg-blue-800 text-white" : "bg-yellow-500 text-red-950 border-2  border-yellow"} px-6 py-3 inline-block top-4 right-4 rounded-md pointer-event-none`;
