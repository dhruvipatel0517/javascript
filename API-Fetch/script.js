...
function UserData(){
    ...
    .then((rawdata)=>{
        ...
        return rawdata.json();//convert raw data into JOSN format
    })
    .then((data)=>{
                ...
                <div class="absolute inset-0 backface-hidden rotate-y-180 bg-indigo-700 rounded-2xl p-6 text-white flex flex-col">
                    ...
                    <div class="space-y-4 text-xs">
                        ...
                        <section>
                            ...
                            <p class="text-sm italic">Lat: ${user.location.coordinates.latitude} /Lon: ${user.location.coordinates.longitude}</p>
                        </section>
                        ...
                        <section>
                            ...
                            <p class="text-sm text-indigo-100">${user.location.timezone.offset} (${user.location.timezone.offset})</p>
                        </section>
                    </div>
